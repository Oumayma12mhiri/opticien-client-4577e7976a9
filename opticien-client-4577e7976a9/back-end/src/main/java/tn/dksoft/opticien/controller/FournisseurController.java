...
//        return fournisseurService.findByCategorieByName(id);
//    }
	
	@GetMapping("/find-by-categorie-name/{name}")
    public List<FournisseurDto> getByCategorieName(@PathVariable String name) throws ParseException {
        return fournisseurService.findByCategorieByName(name);
    }
